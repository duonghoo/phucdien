                            ...
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-wrap">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        @else
                                            <img style="width: 150px; height:auto" src="{{url('admin/images/no-image.jpg')}}" id="lbl_img1" class="img-fluid d-block" onclick="upload_file('chosefile','img1')">
                                        @endif
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        @else
                                            <img style="width: 150px; height:auto" src="{{url('admin/images/no-image.jpg')}}" id="lbl_img2" class="img-fluid d-block" onclick="upload_file('chosefile','img2')">
                                        @endif
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        @else
                                            <img style="width: 150px; height:auto" src="{{url('admin/images/no-image.jpg')}}" id="lbl_img3" class="img-fluid d-block" onclick="upload_file('chosefile','img3')">
                                        @endif
