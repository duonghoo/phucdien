                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a class="btn btn-danger" onclick="return confirm('Bạn có chắc muốn xóa?')" {{$item->id == 14 ? 'disabled' : ''}} href="/admin/category/delete/{{$item->id}}"><svg class="c-icon"><use xlink:href="/admin/images/icon-svg/free.svg#cil-trash"></use></svg></a>
                                    </td>
                                </tr>
                                @endforeach @endif
                            </tbody>
