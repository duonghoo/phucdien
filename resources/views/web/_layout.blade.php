...
<head>
    ...
    <meta name="robots" content="{{ $seo_data['index'] ?? '' }}">
     <title>{{$seo_data['meta_title'] ?? 'Bao bì Phúc Diễn'}}</title> 
    {{-- <title>phucdien</title> --}}
    ...
    <script src="https://silviomoreto.github.io/bootstrap-select/dist/js/bootstrap-select.min.js">
        ...
        src = "https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v14.0&appId=432416328750166&autoLogAppEvents=1"
        nonce = "730jaS1D" >
    </script>
